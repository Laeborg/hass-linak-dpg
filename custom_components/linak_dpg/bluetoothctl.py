...
Original written by Egor Fedorov (https://github.com/kosme/bluetoothctl_lib)
Updated by castis (https://gist.github.com/castis/0b7a162995d0b465ba9c84728e60ec01)
...
class Bluetoothctl:
    ...
    def send(self, command, pause=0):
        ...
        index = self.process.expect(["bluetooth", "DESK", pexpect.EOF])
        if index > 1:
